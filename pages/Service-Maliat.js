...
اعتبار مالیاتی (Tax Credit) یک سیستم مشوق حمایتی است که توسط دولت‌ ها برای کاهش بار مالیاتی شرکت ‌ها و افراد ارائه می ‌شود. این سیستم به طور مستقیم مبلغ مالیات پرداختی را کاهش می ‌دهد؛ برخلاف کسر مالیاتی که فقط درآمد مشمول مالیات را کم می کند. اعتبار مالیاتی می ‌تواند برای اهداف مختلفی از جمله تشویق به سرمایه‌ گذاری در تحقیق و توسعه (R&D)، ایجاد اشتغال، صرفه‌ جویی در انرژی و موارد دیگر اعطا شود. لذا با هدف جهت ¬دهی حمایت¬‌های مالیاتی به سمت توسعه نوآوری و اقتصاد دانش‌¬بنیان و بهره مندی شرکت ها از مزایای اعتبار مالیاتی، سگال ونچرز به عنوان یکی از نهادهای زیر مجموعه هلدینگ سگال در راستای توسعه زیست بوم شرکتی با کمک کارشناسان خبره و نخبگان متخصص در حوزه های مختلف و بهره گیری از شبکه فناوران حرفه ای زیست بوم سگال خدمات ذیل را ارائه می نماید.
