        ...
        <div className="doctors-area pt-100 pb-70">
			<div className="container">
				<div className="section-title">
					<span className="top-title">همراهان ما</span>
                ...
                > 
					<div className="single-doctor">
						...
						<h3>Dr. Jelin Alis</h3>
						<span className="top-title">ارگانهای دولتی</span>
					...
					<div className="single-doctor">
						...
						<span className="top-title">شرکت ها</span>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmodin</p>
					...
					<div className="single-doctor">
						...
						<h3>Dr. Neels Bore</h3>
						<span className="top-title">مراجع علمی</span>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmodin</p>
