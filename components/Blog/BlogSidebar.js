    ...
    return (      
        <div className="widget-area" id="secondary">
            <div className="widget widget_search">
                ...
                <div className="post-wrap">
                    <form className="search-form">
                        <label>
                            <span className="screen-reader-text">جستجو :</span>
                            <input type="search" className="search-field" placeholder="جستجو..." />
                        </label>
                        <button type="submit">
            ...
            <div className="widget widget-peru-posts-thumb">
                <h3 className="widget-title">پست های پر بازدید</h3>
                <div className="post-wrap">
                    <div className="item">
            ...
            <div className="widget widget_categories">
                <h3 className="widget-title">آرشیو</h3>
                <div className="post-wrap">
                    <ul>
                        <li>
            ...
            <div className="widget widget_categories">
                <h3 className="widget-title">دسته بندی</h3>
                <div className="post-wrap">
                    <ul>
                        <li>
            ...
            {/* <div className="widget widget_meta">
                <h3 className="widget-title">متا</h3>
                <div className="post-wrap">
                    <ul>
            ...
            <div className="widget widget_tag_cloud">
                <h3 className="widget-title">تگ ها</h3>
                <div className="post-wrap">
